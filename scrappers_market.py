...
def sky():
    ...
    try:
        ...
        current = span[1].text
        markket_cap = None
        dict_ = insert_into_list('Skycoin', 'SKY', markket_cap, current, resource)
        list_json.append(dict_)
    except:
        pass
...
def ubq():
        ...
        try:
            ...
            dict_ = insert_into_list('Ubiq', 'UBQ', markket_cap, current, resource)
            list_json.append(dict_)
        except:
            pass
...
def spxtx():
    ...
    try:
        ...
        dict_ = insert_into_list('SophiaTX', 'SPHTX', marrket_cap, current, resource)
        list_json.append(dict_)
    except:
        pass
...
coins = dtr(), game(), enj(), sls(), sky(), ubq(), zen(), spxtx(), poa(), xby(), smt()
